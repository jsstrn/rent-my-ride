...
class SearchableBehavior extends ModelBehavior {
   ...
   */
  function beforeDelete(Model $model, $options = array()) {
   ...
   */
  function setSearchableRecords(Model $model, $created = false, $reset = false) {
    if ($reset) {
      $this->_records = array();
    }
   ...
   * @param boolean $created
   */
  function saveSearchIndex(Model $model, $created = false) {
   ...
   */
  protected function _setUrl(Model $model) {
...
//    }
   ...
   * @param string $field
   */
  protected function _setExtra(Model $model, $field) {
   ...
   * @param boolean $created
   */
  protected function _setScope(Model $model, $created) {
   ...
   */
  protected function _getSearchableData(Model $model) {
   ...
   * @param boolean $created
   */
  protected function _initialiseSearchIndexData(Model $model, $created) {
   ...
   */
  function deleteSearchIndex(Model $model, $all = false) {
