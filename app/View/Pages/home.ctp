    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="item active">
          <img class="img-responsive" src="<?php echo $this->webroot . 'img/main/car1.jpg' ;?>" alt="First slide">
        </div>
        <div class="item">
          <img class="img-responsive" src="<?php echo $this->webroot . 'img/main/car2.jpg' ;?>" alt="Second slide">
        </div>
        <div class="item">
          <img class="img-responsive" src="<?php echo $this->webroot . 'img/main/car3.jpg' ;?>" alt="Third slide">
        </div>
      </div>
